import "@/models/EntryModel.js"; // ← guarantees associations before any query
...
function parsePagination(searchParams) {
  ...
  const limit = Math.min(
    MAX_LIMIT,
    Math.max(1, parseInt(rawLimit) || DEFAULT_LIMIT),
  );
...
export const GET = requirePermission("product", "r", async (req) => {
  try {
